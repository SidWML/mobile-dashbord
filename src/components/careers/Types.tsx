...
export default function Types() {
  ...
  return (
    ...
    <div className="flex  justify-between items-center">
        <h1 className=" font-bold text-3xl text-[#a0a0a0]">Types</h1>
    ...
    <h1 className=" py-2 border-b border-dashed">Add New Type</h1>
        <Input  placeholder="Type name" label="Type Name" required />
        <Input before url={router.pathname} placeholder="url" required label="URL" />
        <p className=" text-xs font-light text-slate-600 text-[11px]">( Added Types can be selected from the dropdown while creating the post )</p>
    ...
    <Table action sectionHeading="All Types" rowData={rowData} />
   </div>
  )
}