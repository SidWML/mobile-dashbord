  ...
  return (
   ...
   <div style={{boxShadow:" rgba(0,0,0,.05) 0 1px 4px"}}  className=" w-full space-y-3 px-3 py-4 bg-white  rounded-lg">
    ...
    <div className=" space-y-2">
        ...
        <textarea name="" placeholder='albums description' id="" className='w-full py-2.5 border focus:ring-blue-600 focus:outline-blue-500 px-4 placeholder:text-slate-300 rounded-lg' rows="5"></textarea>
        </div>
    </div>
    <Seo/>
    <div style={{boxShadow:" rgba(0,0,0,.05) 0 1px 4px"}}  className=" w-full space-y-3 px-3 py-4 bg-white  rounded-lg">
